#!/bin/bash
# PRE-MARKET SCAN SUITE - Run all 4 scanners
...
echo "1️⃣ SCANNING PRE-MARKET GAPS (≥5%)..."
echo "─────────────────────────────────────"
python3 premarket_gap_scanner.py
echo ""

echo "2️⃣ SCANNING UNUSUAL OPTIONS FLOW..."
echo "─────────────────────────────────────"
python3 options_flow_scanner.py
echo ""

echo "3️⃣ SCANNING INSIDER CONVICTION BUYS (Code P)..."
echo "─────────────────────────────────────"
python3 form4_conviction_scanner.py
echo ""

echo "4️⃣ SCANNING 8-K CONTRACTS (≥$10M, 12h)..."
echo "─────────────────────────────────────"
